...
A análise da capacidade prática (fator de capacidade real) é fundamental para o planeamento, operação e decisões de investimento no setor elétrico brasileiro. Sendo assim, o objetivo deste trabalho é ajudar no entendimento da capacidade real utilizada pela pelas usinas solares e eólicas, e **embasar empiricamente o planejamento de expansão da rede, a avaliação econômica, a integração do sistema e políticas públicas de regulação**, em parceria com um Engenheiro elétrico da ONS.
